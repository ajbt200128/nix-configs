...
# taken from https://github.com/anatoli-tsinovoy/dotfiles/tree/56a23efa856d4e02db73da88fe2bdd888b3b6e97/aerospace/.config/sketchybar
# found via https://github.com/FelixKratz/SketchyBar/discussions/624#discussioncomment-14444751

# map aerospace display numbers to sketchybar display numbers
map_monitors() {
